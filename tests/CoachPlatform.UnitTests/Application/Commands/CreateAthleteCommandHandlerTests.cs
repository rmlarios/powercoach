...
public class CreateAthleteCommandHandlerTests
{
    ...
    public CreateAthleteCommandHandlerTests()
    {
        ...
        _handler = new CreateAthleteCommandHandler(_contextMock.Object);
    }

    [Fact]
    public async Task Handle_WithValidData_ShouldCreateAthlete()
    {
        // Arrange
    ...
    [Fact]
    public async Task Handle_WithMinimalData_ShouldCreateAthlete()
    {
        // Arrange
        var coach = Coach.Create("Test", "Coach", "coach@example.com");
        SetEntityId(coach, _validCoachId);
